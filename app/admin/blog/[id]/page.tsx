    ...
    fetch(`/api/admin/blog/${params.id}`)
      ...
      .then((post) => {
        ...
        setSeo({
          ...
          // Existing posts have a JSON-LD string already saved; treat it as
          // the starting override so editing an old post doesn't silently
          // rewrite schema the admin may have hand-tuned before this panel existed.
          jsonLdOverride: post.seoJsonLd || null,
        })
      })
