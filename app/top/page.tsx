...
export default async function TopRatedPage() {
  // Prefer verified + high member count as proxy for rating until review aggregates are denormalized
      ...
      <div className="bg-gradient-to-r from-[#2d0808] via-[#4a0e0e] to-[#8b1a1a] text-white">
        <div className="container mx-auto px-4 py-10">
          <div className="flex flex-wrap gap-2 text-xs mb-4">
            ...
            <Link href="/top" className="rounded-full bg-white text-[#4a0e0e] font-semibold px-3 py-1">Rating / Top</Link>
          </div>
          <h1 className="text-3xl font-bold mb-2">Top 100 by rating</h1>
          <p className="text-[#f0c8c8] text-sm max-w-2xl">
            Best Telegram channels, groups and communities ranked by user ratings and engagement.
          </p>
        </div>
      </div>
              ...
              <li key={e.id}>
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    <p className="font-bold text-sm text-[#2d0808]">
                      {e.avgRating != null ? (
                        <>
                    ...
                    <p className="text-[10px] text-[#6b5555]">
                      {e.reviewCount} reviews · {formatCount(e.memberCount)}
                    </p>
                  </div>
                </Link>
              </li>
